 ...
 */
public class Keyword4NewsContentViewHolder extends RecyclerView.ViewHolder {
    ...
    Keyword4NewsContentData newsContentData;

    public Keyword4NewsContentViewHolder(View itemView) {
        super(itemView);

        news_title_textview = (TextView) itemView.findViewById(R.id.news_4_title_textview);
        news_thumbnailUrl_imageview = (ImageView) itemView.findViewById(R.id.news_4_thumbnail_imageview);
        news_write_date_textview = (TextView) itemView.findViewById(R.id.news_4_write_time_textview);
        news_author_textview = (TextView) itemView.findViewById(R.id.news_4_author_textview);
        news_content_textview = (TextView) itemView.findViewById(R.id.news_4_content_textview);
    }

    public void set_NewsContent(Keyword4NewsContentData newsContentData, Context context) {
