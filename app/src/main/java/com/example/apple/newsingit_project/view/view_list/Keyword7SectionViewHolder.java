 ...
 */
public class Keyword7SectionViewHolder extends RecyclerView.ViewHolder {
    public TextView keywordsection_textview;
    Keyword7SectionData keywordSectionData;

    public Keyword7SectionViewHolder(View itemView) {
        super(itemView);

        keywordsection_textview = (TextView) itemView.findViewById(R.id.keyword_7_name_text);
    }

    public void set_KeywordSection(Keyword7SectionData keywordSectionData) {
