 ...
 */
public class Keyword6SectionViewHolder extends RecyclerView.ViewHolder {
    public TextView keywordsection_textview;
    Keyword6SectionData keywordSectionData;

    public Keyword6SectionViewHolder(View itemView) {
        super(itemView);

        keywordsection_textview = (TextView) itemView.findViewById(R.id.keyword_6_name_text);
    }

    public void set_KeywordSection(Keyword6SectionData keywordSectionData) {
