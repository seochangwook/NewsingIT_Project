 ...
 */
public class Keyword10NewsContentViewHolder extends RecyclerView.ViewHolder {
    ...
    Keyword10NewsContentData newsContentData;

    public Keyword10NewsContentViewHolder(View itemView) {
        super(itemView);

        news_title_textview = (TextView) itemView.findViewById(R.id.news_10_title_textview);
        news_thumbnailUrl_imageview = (ImageView) itemView.findViewById(R.id.news_10_thumbnail_imageview);
        news_write_date_textview = (TextView) itemView.findViewById(R.id.news_10_write_time_textview);
        news_author_textview = (TextView) itemView.findViewById(R.id.news_10_author_textview);
        news_content_textview = (TextView) itemView.findViewById(R.id.news_10_content_textview);
    }

    public void set_NewsContent(Keyword10NewsContentData newsContentData, Context context) {
