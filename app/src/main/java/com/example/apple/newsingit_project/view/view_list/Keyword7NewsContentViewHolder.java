 ...
 */
public class Keyword7NewsContentViewHolder extends RecyclerView.ViewHolder {
    ...
    Keyword7NewsContentData newsContentData;

    public Keyword7NewsContentViewHolder(View itemView) {
        super(itemView);

        news_title_textview = (TextView) itemView.findViewById(R.id.news_7_title_textview);
        news_thumbnailUrl_imageview = (ImageView) itemView.findViewById(R.id.news_7_thumbnail_imageview);
        news_write_date_textview = (TextView) itemView.findViewById(R.id.news_7_write_time_textview);
        news_author_textview = (TextView) itemView.findViewById(R.id.news_7_author_textview);
        news_content_textview = (TextView) itemView.findViewById(R.id.news_7_content_textview);
    }

    public void set_NewsContent(Keyword7NewsContentData newsContentData, Context context) {
