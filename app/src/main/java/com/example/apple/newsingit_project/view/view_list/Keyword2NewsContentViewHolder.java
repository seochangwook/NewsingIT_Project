 ...
 */
public class Keyword2NewsContentViewHolder extends RecyclerView.ViewHolder {
    ...
    Keyword2NewsContentData newsContentData;

    public Keyword2NewsContentViewHolder(View itemView) {
        super(itemView);

        news_title_textview = (TextView) itemView.findViewById(R.id.news_2_title_textview);
        news_thumbnailUrl_imageview = (ImageView) itemView.findViewById(R.id.news_2_thumbnail_imageview);
        news_write_date_textview = (TextView) itemView.findViewById(R.id.news_2_write_time_textview);
        news_author_textview = (TextView) itemView.findViewById(R.id.news_2_author_textview);
        news_content_textview = (TextView) itemView.findViewById(R.id.news_2_content_textview);
    }

    public void set_NewsContent(Keyword2NewsContentData newsContentData, Context context) {
