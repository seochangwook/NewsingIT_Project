 ...
 */
public class Keyword8NewsContentViewHolder extends RecyclerView.ViewHolder {
    ...
    Keyword8NewsContentData newsContentData;

    public Keyword8NewsContentViewHolder(View itemView) {
        super(itemView);

        news_title_textview = (TextView) itemView.findViewById(R.id.news_8_title_textview);
        news_thumbnailUrl_imageview = (ImageView) itemView.findViewById(R.id.news_8_thumbnail_imageview);
        news_write_date_textview = (TextView) itemView.findViewById(R.id.news_8_write_time_textview);
        news_author_textview = (TextView) itemView.findViewById(R.id.news_8_author_textview);
        news_content_textview = (TextView) itemView.findViewById(R.id.news_8_content_textview);
    }

    public void set_NewsContent(Keyword8NewsContentData newsContentData, Context context) {
