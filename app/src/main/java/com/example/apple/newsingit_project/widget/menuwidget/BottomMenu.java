package com.example.apple.newsingit_project.widget.menuwidget;
...
/**
 * Bottom navigation that might be used as a main navigation.
 * Items is added using {@link #addItems(List)}.
 * Created by krimat on 30/04/16.
 */
public class BottomMenu extends FrameLayout {

    private final int BOTTOM_MENU_HEIGHT = getResources().getDimensionPixelSize(R.dimen.bottom_bar_height);
