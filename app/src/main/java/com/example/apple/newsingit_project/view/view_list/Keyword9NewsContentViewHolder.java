 ...
 */
public class Keyword9NewsContentViewHolder extends RecyclerView.ViewHolder {
    ...
    Keyword9NewsContentData newsContentData;

    public Keyword9NewsContentViewHolder(View itemView) {
        super(itemView);

        news_title_textview = (TextView) itemView.findViewById(R.id.news_9_title_textview);
        news_thumbnailUrl_imageview = (ImageView) itemView.findViewById(R.id.news_9_thumbnail_imageview);
        news_write_date_textview = (TextView) itemView.findViewById(R.id.news_9_write_time_textview);
        news_author_textview = (TextView) itemView.findViewById(R.id.news_9_author_textview);
        news_content_textview = (TextView) itemView.findViewById(R.id.news_9_content_textview);
    }

    public void set_NewsContent(Keyword9NewsContentData newsContentData, Context context) {
