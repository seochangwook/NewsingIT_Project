 ...
 */
public class Keyword6NewsContentViewHolder extends RecyclerView.ViewHolder {
    ...
    Keyword6NewsContentData newsContentData;

    public Keyword6NewsContentViewHolder(View itemView) {
        super(itemView);

        news_title_textview = (TextView) itemView.findViewById(R.id.news_6_title_textview);
        news_thumbnailUrl_imageview = (ImageView) itemView.findViewById(R.id.news_6_thumbnail_imageview);
        news_write_date_textview = (TextView) itemView.findViewById(R.id.news_6_write_time_textview);
        news_author_textview = (TextView) itemView.findViewById(R.id.news_6_author_textview);
        news_content_textview = (TextView) itemView.findViewById(R.id.news_6_content_textview);
    }

    public void set_NewsContent(Keyword6NewsContentData newsContentData, Context context) {
