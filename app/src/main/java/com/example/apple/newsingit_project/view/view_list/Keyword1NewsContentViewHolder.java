 ...
 */
public class Keyword1NewsContentViewHolder extends RecyclerView.ViewHolder {
    ...
    Keyword1NewsContentData newsContentData;

    public Keyword1NewsContentViewHolder(View itemView) {
        super(itemView);

        news_title_textview = (TextView) itemView.findViewById(R.id.news_title_textview);
        news_thumbnailUrl_imageview = (ImageView) itemView.findViewById(R.id.news_thumbnail_imageview);
        news_write_date_textview = (TextView) itemView.findViewById(R.id.news_write_time_textview);
        news_author_textview = (TextView) itemView.findViewById(R.id.news_author_textview);
        news_content_textview = (TextView) itemView.findViewById(R.id.news_content_textview);
    }
